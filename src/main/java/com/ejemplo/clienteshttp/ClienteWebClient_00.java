 ...
 *
 */
public class ClienteWebClient_00 {
	
    private static final Logger LOG = LogManager.getLogger(ClienteWebClient_00.class.getName());
	...
	private void loadProperties() {
		 ...
		 try (InputStream input = ClienteWebClient_00.class.getClassLoader().getResourceAsStream("app.properties")) {
